...
<img src="banner.png" alt="RetailPulse AI — Project Banner showing 10-level ML pipeline in terminal aesthetic" width="100%" style="border-radius:10px;"/>

<sub>RetailPulse AI · 10-level end-to-end ML pipeline · Rossmann Store Sales · 1,017,209 rows · 1,115 stores · Python · XGBoost · MLflow · FastAPI · Streamlit</sub>
